...
type
  ...
  private
    FQueryable: IColligoQueryable<String>;
...
var
  ...
  LQueryable: IColligoQueryable<TCliente>;
  LResults: IColligoList<TCliente>;
  LClient: TCliente;
begin
  LQueryable := IColligoQueryable<TCliente>.CreateForDatabase(
    procedure(var ADatabase: TDriverName; var AConnection: IDBConnection)
    begin
      ADatabase := TDriverName.dnFirebird;
      AConnection := FConnection;
...
var
  LQueryable: IColligoQueryable<Integer>;
  LResult: String;
begin
  LQueryable := IColligoQueryable<Integer>.CreateForDatabase(
    procedure(var ADatabase: TDriverName; var AConnection: IDBConnection)
    begin
      ADatabase := TDriverName.dnFirebird;
...
var
  ProviderInt: IColligoQueryable<Integer>;
begin
  ProviderInt := IColligoQueryable<Integer>.CreateForDatabase(
    procedure(var ADatabase: TDriverName; var AConnection: IDBConnection)
    begin
      ADatabase := TDriverName.dnFirebird;
      AConnection := TFactoryFireDAC.Create(FFDConnection, ADatabase);
...
var
  ...
  FoundAna, FoundBruno, FoundClara: Boolean;
  LProvider: IColligoQueryable<TTuple<string>>;
  LResults: IColligoList<TTuple<string>>;
begin
  LProvider := IColligoQueryable<TTuple<string>>.CreateForDatabase(
    procedure(var ADatabase: TDriverName; var AConnection: IDBConnection)
    begin
      ADatabase := TDriverName.dnFirebird;
      AConnection := FConnection;
...
var
  LQueryable: IColligoQueryable<string>;
  LResults: IColligoList<string>;
  FoundBruno, FoundClara: Boolean;
  LItem: string;
begin
  LQueryable := IColligoQueryable<string>.CreateForDatabase(
    procedure(var ADatabase: TDriverName; var AConnection: IDBConnection)
    begin
      ADatabase := TDriverName.dnFirebird;
      AConnection := FConnection;
...
var
  LQuery: IColligoQueryable<TCustomer>;
  LInnerQuery: IColligoQueryable<TOrder>;
  LResult: IColligoQueryable<TTuple<string>>;
  LOuterKeyExpr, LInnerKeyExpr, LCustomerIdExpr, LCustomerNameExpr, LOrderDateExpr: IColligoQueryExpression;
  LList: IColligoList<TTuple<string>>;
  LItem: TTuple<string>;
begin
  // Inicializar consultas fluentes
  LQuery := IColligoQueryable<TCustomer>.CreateForDatabase(dnFirebird, FConnection);

  LInnerQuery := IColligoQueryable<TOrder>.CreateForDatabase(dnFirebird, FConnection);
...
var
  LQuery: IColligoQueryable<TTuple<string>>;
  LTempList: IColligoList<TTuple<string>>;
  LGroups: IColligoEnumerable<IGrouping<Integer, TTuple<string>>>;
  LGroup: IGrouping<Integer, TTuple<string>>;
begin
  // Configura a consulta para agrupar pedidos por ID_CLIENTE e contar o total
  LQuery := IColligoQueryable<TTuple<string>>.CreateForDatabase(dnFirebird, FConnection)
...
//var
//  LQuery: IColligoQueryable<TTuple<string>>;
//  LGroups: IColligoList<IGrouping<Integer, TTuple<string>>>;
//  LGroup: IGrouping<Integer, TTuple<string>>;
...
var
  LQuery: IColligoQueryable<TTuple<string>>;
  LResult: IColligoList<TTuple<string>>;
  LExpr: IColligoQueryExpression;
begin
  // Configura a consulta base
  LQuery := IColligoQueryable<TTuple<string>>.CreateForDatabase(dnFirebird, FConnection)
...
var
  LQuery: IColligoQueryable<TTuple<string>>;
  LResult: IColligoList<IGrouping<Integer, TTuple<string>>>;
  LKeyExpr, LCountExpr: IColligoQueryExpression;
  LGroup: IGrouping<Integer, TTuple<string>>;
  LItem: TTuple<string>;
begin
  LQuery := IColligoQueryable<TTuple<string>>.CreateForDatabase(dnFirebird, FConnection)
...
var
  LQuery: IColligoQueryable<TTuple<string>>;
  LResult: IColligoList<TTuple<string>>;
  LNameExpr, LAgeExpr: IColligoQueryExpression;
begin
  // Configura a consulta
  LQuery := IColligoQueryable<TTuple<string>>.CreateForDatabase(dnFirebird, FConnection)
    .Select('ID, NOME, IDADE').From('CLIENTES');
