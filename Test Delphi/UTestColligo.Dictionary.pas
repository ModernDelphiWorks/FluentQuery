...
var
  LDictionary: IColligoDictionary<Integer, String>;
  LMapped: IColligoEnumerable<TPair<Integer, String>>;
  LResult: TDictionary<Integer, String>;
begin
  LDictionary := TColligoDictionary<Integer, String>.Create;
  try
...
var
  LDictionary: TColligoDictionary<Integer, String>;
  LFiltered: IColligoEnumerable<TPair<Integer, String>>;
  LResult: TDictionary<Integer, String>;
begin
  LDictionary := TColligoDictionary<Integer, String>.Create;
  try
...
var
  LDictionary: TColligoDictionary<String, Integer>;
  LResult: TPair<String, Integer>;
begin
  LDictionary := TColligoDictionary<String, Integer>.Create;
  try
...
var
  LDictionary: TColligoDictionary<Integer, String>;
  LTaken: IColligoEnumerable<TPair<Integer, String>>;
  LResult: TDictionary<Integer, String>;
begin
  LDictionary := TColligoDictionary<Integer, String>.Create;
  try
...
var
  LDictionary: TColligoDictionary<Integer, String>;
  LSkipped: IColligoEnumerable<TPair<Integer, String>>;
  LResult: TDictionary<Integer, String>;
begin
  LDictionary := TColligoDictionary<Integer, String>.Create;
  try
...
var
  LDictionary1, LDictionary2: IColligoDictionary<Integer, String>;
  LZipped: IColligoEnumerable<TPair<Integer, String>>;
  LResult: TDictionary<Integer, String>;
begin
  LDictionary1 := TColligoDictionary<Integer, String>.Create;
  LDictionary2 := TColligoDictionary<Integer, String>.Create;
  try
...
var
  LDictionary1: TColligoDictionary<Integer, String>;
  LDictionary2: TColligoDictionary<Integer, String>;
  LJoined: IColligoEnumerable<TPair<Integer, String>>;
  LResult: TDictionary<Integer, String>;
begin
  LDictionary1 := TColligoDictionary<Integer, String>.Create;
  LDictionary2 := TColligoDictionary<Integer, String>.Create;
...
var
  ...
  LTargetDict: IColligoDictionary<Integer, String>;
begin
  LSourceDict := TDictionary<Integer, String>.Create;
  LTargetDict := TColligoDictionary<Integer, String>.Create;
  try
...
var
  LDictionary: TColligoDictionary<Integer, String>;
  LDistinct: IColligoEnumerable<TPair<Integer, String>>;
  LResult: TDictionary<Integer, String>;
begin
  LDictionary := TColligoDictionary<Integer, String>.Create;
  try
...
begin
  LDictionary := TColligoDictionary<Integer, String>.Create(10);
...
var
  LDictionary: TColligoDictionary<Integer, String>;
  LArray: IColligoArray<TPair<Integer, String>>;
begin
  LDictionary := TColligoDictionary<Integer, String>.Create;
  try
    LDictionary.Add(1, 'One');
...
begin
  ...
  LDictionary := TColligoDictionary<Integer, String>.Create(LComparer);
  LDictionary.Add(1, 'One');
  Assert.AreEqual(1, LDictionary.Count, 'Deveria ter 1 elemento');
  Assert.AreEqual('One', LDictionary[1], 'Deveria conter "One" para chave 1');
...
begin
  LComparer := TEqualityComparer<Integer>.Default;
  LDictionary := TColligoDictionary<Integer, String>.Create(5, LComparer);
...
begin
  ...
  try
    ...
    LDictionary := TColligoDictionary<Integer, String>.Create(LSource);
...
begin
  ...
  try
    ...
    LDictionary := TColligoDictionary<Integer, String>.Create(LSource, LComparer);
    Assert.AreEqual(2, LDictionary.Count, 'Deveria ter 2 elementos');
    Assert.AreEqual('One', LDictionary[1], 'Deveria conter "One" para chave 1');
    Assert.AreEqual('Two', LDictionary[2], 'Deveria conter "Two" para chave 2');
    Assert.AreEqual(LComparer, LDictionary.Comparer, 'Deveria usar o comparador fornecido');
...
var
  LDictionary: IColligoDictionary<Integer, String>;
begin
  LDictionary := TColligoDictionary<Integer, String>.Create([TPair<Integer, String>.Create(1, 'One'), TPair<Integer, String>.Create(2, 'Two')]);
  Assert.AreEqual(2, LDictionary.Count, 'Deveria ter 2 elementos');
  Assert.AreEqual('One', LDictionary[1], 'Deveria conter "One" para chave 1');
  Assert.AreEqual('Two', LDictionary[2], 'Deveria conter "Two" para chave 2');
end;
...
begin
  LComparer := TEqualityComparer<Integer>.Default;
  LDictionary := TColligoDictionary<Integer, String>.Create([TPair<Integer, String>.Create(1, 'One'), TPair<Integer, String>.Create(2, 'Two')], LComparer);
  Assert.AreEqual(2, LDictionary.Count, 'Deveria ter 2 elementos');
  Assert.AreEqual('One', LDictionary[1], 'Deveria conter "One" para chave 1');
  Assert.AreEqual('Two', LDictionary[2], 'Deveria conter "Two" para chave 2');
  Assert.AreEqual(LComparer, LDictionary.Comparer, 'Deveria usar o comparador fornecido');
...
begin
  ...
  try
    ...
    LDictionary := TColligoDictionary<Integer, String>.Create(LSourceDict.ToArray);
    Assert.AreEqual(2, LDictionary.Count, 'Deveria ter 2 elementos');
    Assert.AreEqual('One', LDictionary[1], 'Deveria conter "One" para chave 1');
    Assert.AreEqual('Two', LDictionary[2], 'Deveria conter "Two" para chave 2');
...
var
  LSourceDict: TDictionary<Integer, String>;
  LTempDict: TColligoDictionary<Integer, String>;
  LEnumerable: IColligoEnumerable<TPair<Integer, String>>;
  LResult: TDictionary<Integer, String>;
begin
  LSourceDict := TDictionary<Integer, String>.Create;
  try
    ...
    LTempDict := TColligoDictionary<Integer, String>.Create(LSourceDict);
    try
...
var
  ...
  LResult: TDictionary<Integer, String>;
begin
  LTempDict := TColligoDictionary<Integer, String>.Create([TPair<Integer, String>.Create(1, 'One'), TPair<Integer, String>.Create(2, 'Two')]);
  try
    LEnumerable := LTempDict.AsEnumerable;
    LResult := LEnumerable.ToDictionary<Integer, String>(
      function(Pair: TPair<Integer, String>): Integer
...
var
  LDictionary: TColligoDictionary<Integer, String>;
  LEnum: IColligoEnumerator<TPair<Integer, String>>;
  LCount: Integer;
begin
  LDictionary := TColligoDictionary<Integer, String>.Create;
  try
...
var
  LDictionary: IColligoDictionary<Integer, String>;
  LResult: IColligoArray<TPair<Integer, String>>;
begin
  LDictionary := TColligoDictionary<Integer, String>.Create;
  LDictionary.Add(1, 'One');
  LDictionary.Add(2, 'Two');
...
begin
  ...
  // OfType<TPair<Integer,String>>() sobre uma coleção já desse tipo mantém
  // TODOS os elementos (todos passam no teste de tipo) — sem argumentos, sem
...
var
  ...
  LDict: IColligoDictionary<Integer, TStringList>;
  LDictStr: IColligoDictionary<Integer, String>;
begin
  LDict := TColligoDictionary<Integer, TStringList>.Create([doOwnsValues]);
  LDictStr := TColligoDictionary<Integer, String>.Create;
...
var
  ...
  LEnum: IColligoEnumerator<IGrouping<string, TPair<Integer, string>>>;
...
var
  LDictionary1, LDictionary2: TColligoDictionary<Integer, String>;
  LResult: IColligoArray<String>;
begin
  LDictionary1 := TColligoDictionary<Integer, String>.Create;
  LDictionary2 := TColligoDictionary<Integer, String>.Create;
  try
    ...
    LResult := LDictionary1.AsEnumerable.OrderBy(
      ...
      function(Pair1: TPair<Integer, String>; Inner: IColligoEnumerableAdapter<TPair<Integer, String>>): String
      var
        LInnerArray: IColligoArray<TPair<Integer, String>>;
      begin
...
begin
  LDict := TColligoDictionary<Integer, TStringList>.Create([doOwnsValues]); // OwnsValues = True
...
var
  LDictionary: TColligoDictionary<Integer, String>;
  LList: IColligoList<TPair<Integer, String>>;
